  ...
  return (
    <div className="itinerary">
        ...
        <div className="itinerary-text">  
            <h1 className="underline">Itinerary</h1>
            ...
            <p className="list-item">6.30pm: Drinks and Hooch pong @ <a href="https://www.cheapdatesbar.co.uk/" className="link">Cheap Dates</a></p>
